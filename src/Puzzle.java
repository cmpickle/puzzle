...
public class Puzzle extends JFrame implements MouseListener
{
	...
	private	Border			selected = BorderFactory.createLineBorder(Color.RED);	// border of selected puzzle piece
	...
	//private	JComboBox		choices;		// Java 6 and earlier
	private	JComboBox<String>	choices;			// Java 7 and later
	private	int			size = 6;
	private	int			pieces;
	...
	public Puzzle()
	{
		...
		//choices = new JComboBox(pieces);		// Java 6 and ealier
	...
	/*private String getFileName()
	{
		String[] imageList = { "arches1.jpg", "arches3.jpg", "arches4.jpg",
							"arches5.jpg", "arches9.jpg", "arches11.jpg", "gtet04_m.jpg" };
		//JList chooser = new JList(imageList);			// Java 6 and earlier
